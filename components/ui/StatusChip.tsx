import type { VersionStatus } from '@/src/models/GameVersion';
...
const statusConfig: Record<VersionStatus, { label: string; className: string }> = {
  draft: { label: 'Nháp', className: 'bg-slate-100 text-slate-700' },
  uploaded: { label: 'Chờ QC', className: 'bg-blue-100 text-blue-700' },
  qc_processing: { label: 'Đang QC', className: 'bg-yellow-100 text-yellow-700' },
