...
function checkGitHubAuth(): void {
  ...
  const envToken = process.env.GAME_HUB_MANAGER_GITHUB_TOKEN;
  if (envToken) {
    console.log(
      "✅ GAME_HUB_MANAGER_GITHUB_TOKEN found in environment variables",
    );
  ...
  const fileToken = envFile.GAME_HUB_MANAGER_GITHUB_TOKEN;

  if (fileToken) {
    console.log("✅ GAME_HUB_MANAGER_GITHUB_TOKEN found in .env file");
  ...
  // No token found
  console.log("❌ GAME_HUB_MANAGER_GITHUB_TOKEN not found");
  console.log("");
  ...
  console.log("   GAME_HUB_MANAGER_GITHUB_TOKEN=your_token_here");
  console.log("");
  console.log("3. Or set as environment variable:");
  console.log(
    "   export GAME_HUB_MANAGER_GITHUB_TOKEN=your_token_here  # Linux/Mac",
  );
  console.log(
    '   $env:GAME_HUB_MANAGER_GITHUB_TOKEN="your_token_here"  # Windows PowerShell',
  );
}
