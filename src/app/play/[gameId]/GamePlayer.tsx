  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-slate-50" id="game-container">
        ...
        <div
          className={`bg-white border-b border-slate-200 px-3 sm:px-4 py-2 sm:py-3 sticky top-0 z-10 transition-transform duration-300 ${
          ...
          >
            <svg
              className={`w-5 h-5 transition-transform duration-300 ${
                showToolbarInFullscreen ? "rotate-180" : ""
              }`}
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
          ...
          >
            <div className="text-center">
              ...
              <p className="text-xs text-slate-400 mt-2">
                Click để ẩn nếu game đã sẵn sàng
              </p>
            </div>
          </div>
        </div>
